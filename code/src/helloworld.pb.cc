...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::helloworld::HelloReply, messa_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::helloworld::HelloReply, num2_),
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "equest\022\014\n\004name\030\001 \001(\t\")\n\nHelloReply\022\r\n\005me"
      "ssa\030\001 \001(\t\022\014\n\004num2\030\002 \001(\0052I\n\007Greeter\022>\n\010Sa"
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int HelloReply::kMessaFieldNumber;
const int HelloReply::kNum2FieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
HelloReply::HelloReply(const HelloReply& from)
  : ::google::protobuf::Message(),
      ...
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  messa_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.messa().size() > 0) {
    messa_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.messa_);
  }
  num2_ = from.num2_;
...
void HelloReply::SharedDtor() {
  messa_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u /* 10 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_messa()));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->messa().data(), static_cast<int>(this->messa().length()),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "helloworld.HelloReply.messa"));
        } else {
          goto handle_unusual;
        }
        break;
